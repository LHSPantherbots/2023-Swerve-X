...
public class LoadStationSideCubePickupDock extends SequentialCommandGroup {
    public LoadStationSideCubePickupDock(
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("LoadStationSideCubePickupDock", new PathConstraints(3, 2), false);
