...
public class ConeScoreHigh_OLD extends SequentialCommandGroup {
  /** Creates a new IntakeConeCommand. */
  public ConeScoreHigh_OLD(CrossSlideSubsystem crossSlide, IntakePivotSubsystem intakePivot, ElevatorSubsystem elevatorSubsystem) {
