...
public class CubeScoreHigh_OLD extends SequentialCommandGroup {
  /** Creates a new IntakeCubeCommand. */
  public CubeScoreHigh_OLD(CrossSlideSubsystem crossSlide, IntakePivotSubsystem intakePivot, ElevatorSubsystem elevatorSubsystem) {
