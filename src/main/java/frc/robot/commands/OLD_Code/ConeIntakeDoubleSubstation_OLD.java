...
public class ConeIntakeDoubleSubstation_OLD extends SequentialCommandGroup {
  /** Creates a new IntakeConeCommand. */
  public ConeIntakeDoubleSubstation_OLD(CrossSlideSubsystem crossSlide, IntakePivotSubsystem intakePivot, ElevatorSubsystem elevatorSubsystem) {
