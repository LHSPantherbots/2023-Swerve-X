...
public class ConeScoreMid_OLD extends SequentialCommandGroup {
  /** Creates a new IntakeConeCommand. */
  public ConeScoreMid_OLD(CrossSlideSubsystem crossSlide, IntakePivotSubsystem intakePivot, ElevatorSubsystem elevatorSubsystem) {
