...
public class TwoCubeAuto extends SequentialCommandGroup {
  ...
  private final Trajectory tj1 =
      TrajectoryGenerator.generateTrajectory(
          new Pose2d(0, 0, new Rotation2d(0)),
          List.of(new Translation2d(0.075, 0)),
          new Pose2d(0.152, 0, new Rotation2d(0)),
          config);
  private final Trajectory tj2 =
      TrajectoryGenerator.generateTrajectory(
          new Pose2d(0.152, 0, new Rotation2d(0)),
          List.of(new Translation2d(-0.9, -0.152)),
          new Pose2d(-4.45, -0.152, new Rotation2d(1)),
          config);
  private final Trajectory tj3 =
      TrajectoryGenerator.generateTrajectory(
          new Pose2d(-4.45, -0.152, new Rotation2d(1)),
          List.of(new Translation2d(-0.9, -0.152)),
          new Pose2d(0, 1.676, new Rotation2d(0)),
          config);
  private final Trajectory tj4 =
      TrajectoryGenerator.generateTrajectory(
          new Pose2d(0, 1.676, new Rotation2d(0)),
          List.of(new Translation2d(0.075, 1.676)),
          new Pose2d(0.152, 1.676, new Rotation2d(0)),
          config);
  private final Trajectory tj5 =
      TrajectoryGenerator.generateTrajectory(
          new Pose2d(0.152, 1.676, new Rotation2d(0)),
          List.of(new Translation2d(0.919, 1.676)),
  ...
  public TwoCubeAuto(DriveSubsystem subsystem) {
    ...
    addCommands(
        ...
        new InstantCommand(
            () -> m_DriveSubsystem.resetOdometry(tj1.getInitialPose()), m_DriveSubsystem),
