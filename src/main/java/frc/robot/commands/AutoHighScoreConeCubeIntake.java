...
public class AutoHighScoreConeCubeIntake extends SequentialCommandGroup {
  ...
  public AutoHighScoreConeCubeIntake(DriveSubsystem driveTrain, ElevatorSubsystem elevator, CrossSlideSubsystem crossslide, IntakePivotSubsystem intakepivot, IntakeSubsystem intake) {
    ...
    Trajectory exampleTrajectory =
     TrajectoryGenerator.generateTrajectory(
         ...
         new Pose2d(5.0, 0.0, new Rotation2d(Math.PI)),
         //config);
         rev_config);
