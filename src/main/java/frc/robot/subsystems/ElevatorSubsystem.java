...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  CANSparkMax liftMotor =
      new CANSparkMax(ElevatorConstants.leftElavatorMotor_ID, MotorType.kBrushless);
  CANSparkMax secondaryLiftMotor =
      new CANSparkMax(ElevatorConstants.rightElavatorMotor_ID, MotorType.kBrushless);
