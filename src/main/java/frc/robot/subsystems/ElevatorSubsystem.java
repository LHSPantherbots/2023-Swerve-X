...
public class ElevatorSubsystem extends SubsystemBase {
  ...
  CANSparkMax elevatorLeader =
      new CANSparkMax(RIO_Channels_CAN_MOTOR.ELEVATOR_LEADER, MotorType.kBrushless);
  CANSparkMax elevatorFollower =
      new CANSparkMax(RIO_Channels_CAN_MOTOR.ELEVATOR_FOLLOWER, MotorType.kBrushless);
  ...
  public void closedLoopElevator() {
    elevatorLeader.set(
        arbitraryFeedForward
            + m_controller.calculate(elevatorEncoder.getPosition(), heightSetpoint));
